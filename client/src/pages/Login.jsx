...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4 dark:bg-slate-950">
      <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-6 shadow-sm xs:p-8 dark:border-slate-800 dark:bg-slate-900">
        <h1 className="page-title mb-1 font-semibold text-slate-900 dark:text-slate-100">RentyPark</h1>
        <p className="mb-6 text-sm text-slate-500 dark:text-slate-400">Sign in to your station</p>
